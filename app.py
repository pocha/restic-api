        ...
        if 'file' in request.files:
            ...
            try:
                ...
                if current_platform == 'linux':
                    ...
                    spec = importlib.util.spec_from_file_location("linux_installer", "binaries/linux_restic_installer.py")
                    ...
                    import importlib.util
                    spec = importlib.util.spec_from_file_location("windows_installer", "binaries/windows_restic_installer.py")
