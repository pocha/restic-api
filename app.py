        ...
        if 'file' in request.files:
            ...
            try:
                ...
                if current_platform == 'linux':
                    ...
                    spec = importlib.util.spec_from_file_location("linux_installer", "linux_restic_installer.py")
                    ...
                    import importlib.util
                    spec = importlib.util.spec_from_file_location("windows_installer", "windows_restic_installer.py")
